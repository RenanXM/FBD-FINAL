...
CREATE TABLE telefone(
	...
	CONSTRAINT FK_GRAV_TEL FOREIGN KEY (cod_grav) REFERENCES gravadora ON DELETE CASCADE
...
CREATE TABLE meio_fisico (
	...
	CONSTRAINT FK_COD_ALBUM_MF FOREIGN KEY (cod_album) REFERENCES album ON DELETE CASCADE
)  ON BDSpotPer_fg01;
...
CREATE TABLE faixa_interprete(
	...
	CONSTRAINT FK_FAIXA_FI FOREIGN KEY (cod_faixa) REFERENCES faixa ON DELETE CASCADE,
	CONSTRAINT FK_INTERP_FI FOREIGN KEY (cod_interp) REFERENCES interprete ON DELETE CASCADE
...
CREATE TABLE faixa_compositor(
	...
	CONSTRAINT FK_FAIXA_FC FOREIGN KEY (cod_faixa) REFERENCES faixa ON DELETE CASCADE,
	CONSTRAINT FK_COMP_FC FOREIGN KEY (cod_comp) REFERENCES compositor ON DELETE CASCADE
...
CREATE TABLE faixa_playlist(
	...
	CONSTRAINT FK_FAIXA_FP FOREIGN KEY (cod_faixa) REFERENCES faixa ON DELETE CASCADE,
	CONSTRAINT FK_PLAYLIST_FP FOREIGN KEY (cod_playlist) REFERENCES playlist ON DELETE CASCADE
